    ...
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        ...
        <p className="text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left">
          ...
          sequi esse beatae aperiam? Quo voluptas assumenda incidunt vel ratione
          ex necessitatibus, laborum, aliquid voluptates doloribus fugiat
          perspiciatis consequuntur obcaecati.
        </p>
      ...
      <div className="hidden lg:block lg:1/2">
        <img className="w-full" src={images.heroImage} alt="reading blogs" />
      </div>
    </section>
  );
};
