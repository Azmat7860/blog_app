...
import {
  ...
  deleteCategory,
  getAllCategories,
} from "../../../../service/index/postCategories";
            ...
            <tr>
              ...
              <td className="px-5 py-5 text-sm bg-white border-b border-gray-200 space-x-5">
                <Link
                  ...
                  className="text-indigo-600 hover:text-indigo-900 bg-cyan-200 rounded-full px-5 py-2 mx-1"
                >
                  Edit
                </Link>
                <button
                  ...
                  type="button"
                  className="text-white hover:text-slate-200 bg-red-500 rounded-full px-3 py-2"
                  onClick={() => {
                    deleteDataHandler({
                      slug: category?._id,
                      token: userState.userInfo.token,
